...
public class MotionProfileFollower {
        ...
        if (_talon.getControlMode() != ControlMode.MotionProfile) {
            ...
            switch (_state) {
                case 0: /* wait for application to tell us to start an MP */
                    ...
                    break;
                case 1: /*
                         * wait for MP to stream to Talon, really just the first
                         * few points
                         */
    ...
    private void startFilling(double[][] profile, int totalCnt) {
        ...
        for (int i = 0; i < totalCnt; ++i) {
            ...
            point.position = positionRot * Constants.kSensorUnitsPerRotation; // Convert
                                                                              // Revolutions
                                                                              // to
                                                                              // Units
            point.velocity = velocityRPM * Constants.kSensorUnitsPerRotation / 600.0; // Convert
                                                                                      // RPM
                                                                                      // to
                                                                                      // Units/100ms
            point.headingDeg = 0; /*
            ...
            point.profileSlotSelect1 = 0; /*
                                           * future feature - not used in this
                                           * example - cascaded PID [0,1], leave
                                           * zero
                                           */
